  ...
  fn process_resource_pots(
    ...
    for resource_pot in resource_pots {
      if matches!(resource_pot.resource_pot_type, ResourcePotType::Runtime) {
        ...
        bundle.prepend(
          r#"(function(r,e){var t={};function n(r){return Promise.resolve(o(r))}function o(e){if(t[e])return t[e].exports;var i={id:e,exports:{},_m:function(){},o:function(a,b,c){a[b]=c()}};t[e]=i;r[e](i,i.exports,o,n);return i.exports}o(e)})("#,
        );
